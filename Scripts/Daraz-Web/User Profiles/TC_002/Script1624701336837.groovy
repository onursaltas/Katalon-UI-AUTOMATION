...
WebUI.click(findTestObject('Object Repository/User Profile/changePassword/Page_Homepage/a_Signup  Login'))
...
WebUI.click(findTestObject('Object Repository/User Profile/changePassword/Page_Homepage/span_Md Mahabub Hossain Shozibs account'))

WebUI.click(findTestObject('Object Repository/User Profile/changePassword/Page_Homepage/a_Manage My Account'))
