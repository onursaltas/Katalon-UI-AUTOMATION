...
'And user input invalid ponsel'
WebUI.setText(findTestObject('Object Repository/Login/inputPonselEmail'), '081212345566')

'And user click button masuk'
WebUI.click(findTestObject('Object Repository/Login/buttonTextMasuk'))

'Then user will see error message'
WebUI.verifyElementPresent(findTestObject('Object Repository/Login/labelPopupPhoneEmailNotRegister'), 0)
WebUI.closeBrowser()