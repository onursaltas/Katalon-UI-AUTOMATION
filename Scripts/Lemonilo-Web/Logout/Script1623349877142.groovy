...
WebUI.mouseOver(findTestObject('Object Repository/Lemonilo/Logout/button_dropdown'))

'Then user click button keluar'
WebUI.click(findTestObject('Object Repository/Lemonilo/Logout/button_keluar'))
