...
WebUI.setText(findTestObject('Object Repository/Lemonilo/Login Valid/input_email'), 'te4@mailinator.com')
...
'Then user will see error on email field'
WebUI.verifyElementPresent(findTestObject('Object Repository/Lemonilo/Login Invalid Email/invalid_email'), 5)
