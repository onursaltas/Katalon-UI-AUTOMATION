...
'Verifikasi jika user bisa klik button news di toolbar'
...
'And user memastikan bahwa user sudah berada dihalaman news'
WebUI.verifyElementPresent(findTestObject('Object Repository/seeNews/labelTextNews'), 5)

'Then user keluar dari website'
WebUI.closeBrowser()