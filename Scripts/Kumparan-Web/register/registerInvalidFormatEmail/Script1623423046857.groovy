...
'Verifikasi jika user tidak bisa mengisi field email dengan format yang salah'
...
WebUI.click(findTestObject('Object Repository/register/buttonRegister'))

'Then user akan melihat popup error'
WebUI.verifyElementPresent(findTestObject('Object Repository/login/labelFormatEmail'), 0)