...
'Verifikasi user tidak bisa login jika field email dan password kosong'
...
WebUI.setText(findTestObject('Object Repository/login/inputEmail'), '')

WebUI.setText(findTestObject('Object Repository/login/inputPassword'), '')
