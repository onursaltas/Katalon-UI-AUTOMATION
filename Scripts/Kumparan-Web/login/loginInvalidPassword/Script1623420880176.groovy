...
'Verifikasi user tidak bisa login jika memasukkan password yang salah'
...
WebUI.setText(findTestObject('Object Repository/login/inputPassword'), 'priaidamanwanita123')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/login/labelEmailAtauPasswordSalah'), 0)