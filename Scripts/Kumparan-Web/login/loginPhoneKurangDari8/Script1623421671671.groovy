...
'Verifikasi jika user tidak bisa memasukkan nomor handphone kurang dari 8 karakter'
...
WebUI.click(findTestObject('Object Repository/login/buttonNomorHandphone'))

'And user input nomor handphnoe'
WebUI.setText(findTestObject('Object Repository/login/inputNomorHandphone'), '0812')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/login/labelTextMin8Karakter'), 0)