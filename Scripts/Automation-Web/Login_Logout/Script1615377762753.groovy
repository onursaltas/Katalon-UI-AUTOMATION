...
WebUI.verifyElementText(findTestObject('Customer Account Page/My account header'), 'MY ACCOUNT')

WebUI.click(findTestObject('Customer Account Page/Sign out button'))
