...
WebUI.verifyElementText(findTestObject('Checkout Overview/Sauce Labs Backpack Checkout'), 'Sauce Labs Backpack')

WebUI.click(findTestObject('Checkout Overview/Finish button'))

WebUI.verifyElementPresent(findTestObject('Thank you note/Checkout complete container'), 2)
